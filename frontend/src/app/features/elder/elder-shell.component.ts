            ...
            <div class="relative">
              ...
              <button (click)="dropdownOpen.set(!dropdownOpen())"
                ...
                <div *ngIf="!auth.currentUser()?.avatar_url"
                     class="w-8 h-8 bg-green-700 rounded-full flex items-center justify-center shadow-sm
                            ring-2 ring-transparent hover:ring-green-500 transition-all">
                  <span class="text-white text-xs font-bold">{{ initials() }}</span>
                </div>
              </button>
              <div *ngIf="dropdownOpen()"
                ...
                <div class="px-4 py-3 border-b border-slate-50">
                  ...
                  <p class="text-[10px] text-slate-400">ሽማግሌ</p>
                </div>
                <a routerLink="/elder/settings" (click)="dropdownOpen.set(false)"
